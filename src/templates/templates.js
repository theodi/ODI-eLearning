...
this["Handlebars"]["templates"]["dynamic-narrative"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); partials = this.merge(partials, Handlebars.partials); data = data || {};
  var buffer = "", stack1, functionType="function", escapeExpression=this.escapeExpression, self=this;
...
function program1(depth0,data) {
  ...
  return "dynamic-narrative-text-controls";
  }
...
function program5(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n                <div class=\"dynamic-narrative-slider-graphic ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.visited), {hash:{},inverse:self.noop,fn:self.program(6, program6, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\">\n		    ";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 && depth0._graphic)),stack1 == null || stack1 === false ? stack1 : stack1.src), {hash:{},inverse:self.noop,fn:self.program(8, program8, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n		    ";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 && depth0._iframe)),stack1 == null || stack1 === false ? stack1 : stack1.src), {hash:{},inverse:self.noop,fn:self.program(10, program10, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n		</div>\n                ";
  return buffer;
  }
...
function program10(depth0,data) {
  ...
  buffer += "\n		   	<iframe scrolling=\"no\" class=\"responsiveIframe-iframe\" src=\""
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0._iframe)),stack1 == null || stack1 === false ? stack1 : stack1.src)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
...
function program16(depth0,data) {
  ...
  stack1 = self.invokePartial(partials.component, 'component', depth0, helpers, partials, data);
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n    <div class=\"dynamic-narrative-widget component-widget ";
  ...
  stack1 = helpers.each.call(depth0, (depth0 && depth0._items), {hash:{},inverse:self.noop,fn:self.program(14, program14, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n                </div>\n                <a href=\"#\" class=\"dynamic-narrative-controls dynamic-narrative-control-right\">\n                    <div class=\"icon icon-controls-right\"></div>\n                </a>\n                ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0._items), {hash:{},inverse:self.noop,fn:self.program(16, program16, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            </div>\n        </div>\n\n    </div>    \n</div>\n";
  return buffer;
  });
